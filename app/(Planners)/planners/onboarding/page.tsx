...
export default function OnboardingPage() {
    ...
    useEffect(() => {
        if (!isLoading && !isAuthenticated) {
            router.replace("/login?redirect=/planners/onboarding");
        }
                        ...
                        return (
                            <div
                                ...
                                className={`h-1 flex-1 rounded-full transition-colors ${
                                    done ? "bg-[#0F766E]" : active ? "bg-[#0F766E]" : "bg-neutral-200"
                                }`}
                            />
                        );
                    })}
                ...
                {step === "welcome" && (
                    <div className="space-y-6">
                        ...
                        <div className="space-y-3 text-neutral-600 leading-relaxed">
                            <p>
                                Planner&apos;s Planner AI는 단순 일정 관리가 아닙니다.
                            </p>
                            <p>
                        ...
                        <button
                            ...
                            className="mt-8 flex items-center gap-2 px-6 py-3 bg-[#0F766E] text-white rounded-lg hover:bg-[#0d5e56] transition-colors"
                        >
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            ...
                            >
                                <div className="flex items-center gap-2 mb-3">
                                    <CalendarMini />
                                    <span className="text-xs font-semibold text-[#0F766E] uppercase tracking-wider">Weekly</span>
                            ...
                            >
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-xs font-semibold text-[#0F766E] uppercase tracking-wider">All in One</span>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-white border border-neutral-200 rounded-lg px-4 py-3 text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:border-[#0F766E]"
                                />
                            </div>
                            <div>
                        ...
                        <div className="flex justify-between pt-4">
                            ...
                            <button
                                ...
                                disabled={saving}
                                className="flex items-center gap-2 px-6 py-2.5 bg-[#0F766E] text-white rounded-lg hover:bg-[#0d5e56] transition-colors disabled:opacity-50"
                            >
...
function CalendarMini() {
    return (
        <div className="w-4 h-4 rounded border-2 border-[#0F766E] flex items-center justify-center">
            <div className="w-1 h-1 bg-[#0F766E] rounded-full" />
        </div>
    );
}
