...
// ─── 가이드 구조 ────────────────────────────────────────────────────────
// 단순 FAQ가 아니라 "기능별 사용 매뉴얼". 섹션마다:
//   intro = 그 기능이 왜 있는가 (한 줄 의미)
//   steps = 어떻게 쓰는가 (실제 동작)
//   tip   = 알아두면 좋은 것 (선택)
...
const SECTIONS: Section[] = [
    {
        ...
        icon: Compass,
        title: "시작하기",
        intro: "Planner's Planner AI는 당신이 매일 자신의 기획자로 살아가도록 곁에 둔 도구입니다. 가입과 온보딩을 한 번 마치면, 이후엔 페이지를 넘기듯 머물기만 하면 됩니다.",
        steps: [
    ...
    },
    {
        ...
        steps: [
            ...
            { label: "참조 범위", detail: "아이덴티티 · 이번 주 · 이번 달 · 프로젝트 · 오늘 할 일 중 원하는 항목만 체크." },
    ...
    },
    {
        ...
        steps: [
            ...
            { label: "푸시 (PWA)", detail: "홈 화면에 설치된 PP AI에 즉시 푸시. 브라우저별 권한 허용 후 작동." },
        ],
    },
    {
        id: "personalize",
