...
import { ChevronLeft, ShoppingCart, Package, AlertCircle, Heart, Share2, Check, Link2, X } from "lucide-react";
import { getProductById, isProductLiked, toggleProductLike, type JakkaProduct, type JakkaCreator } from "@/lib/supabase/jakka";
...
export default function MarketProductDetailPage() {
    ...
    useEffect(() => {
        if (!id || !user?.id) { setLiked(false); return; }
