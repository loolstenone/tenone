...
export default function YouInOneMyPage() {
    ...
    if (isLoading) return <div className="min-h-screen flex items-center justify-center bg-neutral-900"><div className="h-6 w-6 border-2 border-neutral-600 border-t-[#1AAD64] rounded-full animate-spin" /></div>;
    if (!isAuthenticated) return <div className="min-h-screen bg-neutral-900"><LoginModal isOpen={true} onClose={() => {}} accentColor="#1AAD64" /></div>;
    ...
    return (
        <div className="min-h-screen pt-24 pb-20 px-6 bg-neutral-900 text-neutral-100">
            <div className="max-w-4xl mx-auto">
                ...
                {user?.id && <CapabilitySection memberId={user.id} brandId="youinone" accentColor="#1AAD64" className="mb-6" />}
