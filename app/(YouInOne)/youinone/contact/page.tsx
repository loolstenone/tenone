        ...
        <div>
            ...
            <section className="bg-[#171717] py-16 md:py-24 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <p className="text-[#1AAD64] text-sm font-medium tracking-widest mb-4">CONTACT</p>
                    <h1 className="text-white text-2xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                        세상을 바꾸는 프로젝트<br />
                        <span className="text-[#1AAD64]">당신의 고민을 이야기해 주세요</span>
                    </h1>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10 md:mb-16">
                        <div className="p-8 bg-neutral-50 rounded-xl">
                            <Mail className="h-8 w-8 text-[#1AAD64] mb-4" />
                            <h3 className="text-lg font-bold mb-2">Email</h3>
                            <a
                                href="mailto:YouInOne.com@gmail.com"
                                className="text-neutral-600 hover:text-[#1AAD64] transition-colors"
                            >
                                YouInOne.com@gmail.com
                            </a>
                        </div>
                        <div className="p-8 bg-neutral-50 rounded-xl">
                            <MessageCircle className="h-8 w-8 text-[#1AAD64] mb-4" />
                            <h3 className="text-lg font-bold mb-2">KakaoTalk</h3>
                            <a
                                href="https://open.kakao.com/me/youinone"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-neutral-600 hover:text-[#1AAD64] transition-colors flex items-center gap-1"
                            >
                    ...
                    <div className="space-y-6">
                        ...
                        {[
                            ...
                            <div key={i} className="flex items-center gap-4 p-4 border border-neutral-200 rounded-lg hover:border-[#1AAD64]/30 transition-colors">
                                <span className="shrink-0 w-8 h-8 bg-[#1AAD64]/10 text-[#1AAD64] font-bold text-sm rounded-full flex items-center justify-center">
                                    {i + 1}
                                </span>
