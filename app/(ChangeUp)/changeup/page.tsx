                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {programs.map((prog) => (
                                <div key={prog.title} className="border border-neutral-200 rounded-2xl p-6 hover:shadow-lg transition-shadow group">
                                    ...
                                    <Link href="/changeup/programs" className="inline-flex items-center gap-1 text-sm text-[#1AAD64] font-medium mt-4 hover:gap-2 transition-all">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {investModels.map((model) => (
                                <div key={model.title} className="border border-neutral-200 rounded-2xl p-6 hover:shadow-lg transition-shadow group">
                                    ...
                                    <Link href="/changeup/invest" className="inline-flex items-center gap-1 text-sm text-[#256EFF] font-medium mt-4 hover:gap-2 transition-all">
                                        자세히 보기 <ChevronRight className="w-4 h-4" />
                                    </Link>
                                </div>
                            ))}
            ...
            <section className="py-20 bg-neutral-50">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="flex items-center justify-between mb-10">
                        ...
                        <Link href="/changeup/startups" className="hidden sm:inline-flex items-center gap-1 text-sm text-[#1AAD64] font-medium hover:gap-2 transition-all">
            ...
            <section className="py-20">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <Link href="/changeup/community" className="text-sm text-neutral-500 hover:text-neutral-900 transition-colors">
                            전체 보기 &rarr;
                        </Link>
                    </div>
                    <div className="divide-y divide-neutral-200 border-t border-b border-neutral-200">
                        {notices.map((notice) => (
                            <Link key={notice.id} href="/changeup/community" className="flex items-center gap-4 py-4 hover:bg-neutral-50 px-2 -mx-2 rounded transition-colors">
                                {notice.pinned && (
