...
export default function RooKMyPage() {
    ...
    if (isLoading || !isAuthenticated) return <div className="min-h-screen flex items-center justify-center bg-neutral-900"><div className="h-6 w-6 border-2 border-neutral-600 border-t-[#1E88E5] rounded-full animate-spin" /></div>;
            ...
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center gap-6 mb-10">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-[#1E88E5] mt-1">RooK Creator</p>
                    </div>
                </div>
