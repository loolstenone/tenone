...
- ❌ 무료 플랜 사용자가 `/dashboard/creative` 접근 시 Preview Gate (업그레이드 유도)
- ✅ 각 페이지 상단에 `<SmarCommPreviewGate requiredPlan="pro" />`
- 모달 메시지: "이 기능은 Pro 플랜 이상에서 사용 가능합니다. [업그레이드]"
...
| 항목 | 내용 |
|------|------|
| **Phase** | Launch (2026-04-20) — 출시 준비 완료. 대시보드 UI 완성. |
| **개발 수준** | 마케팅 페이지·대시보드 완성. AI 광고 최적화 기능 구현 중. |
| **이월 작업** | 없음 — UI/UX 확정됨 |
| **최근 결정** | 경쟁사 비교 레이더 차트 추가, 구독 플랜별 피쳐 확정 |
