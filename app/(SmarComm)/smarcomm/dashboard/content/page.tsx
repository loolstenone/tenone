  ...
  return (
    <div className="max-w-6xl">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link href="/smarcomm/dashboard/creative" className="flex items-center gap-1.5 rounded-xl bg-text px-4 py-2.5 text-xs font-semibold text-white hover:bg-accent-sub">
      ...
      <NextStepCTA stage="제작 → 실행" title="제작된 콘텐츠를 광고 채널에 집행" description="SEO 최적화된 콘텐츠를 캠페인 소재로 바로 활용하세요" actionLabel="캠페인 집행" href="/smarcomm/dashboard/campaigns" />
    </div>
  );
}
            ...
            {AI_TOPICS.map((topic, i) => (
              <div key={i} className="rounded-2xl border border-border bg-white p-5 hover:shadow-md transition-all">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <Link href="/smarcomm/dashboard/creative" className="shrink-0 flex items-center gap-1 rounded-lg bg-surface px-3 py-2 text-[10px] font-semibold text-text-sub hover:bg-text hover:text-white transition-colors">
