...
const MOCK_INSIGHTS: Insight[] = [
  { id: 'i1', severity: 'danger', stage: 'consideration', title: 'Consideration 단계 전환율 급락',
    ...
    action: 'A/B 테스트 시작', actionHref: '/smarcomm/dashboard/abtest', impact: 'high', ease: 'medium', status: 'new', createdAt: '2026-03-22' },
  { id: 'i2', severity: 'warning', stage: 'retention', title: 'Retention 재방문율 하락 추세',
    ...
    action: '자동화 설정', actionHref: '/smarcomm/dashboard/workflow/automation', impact: 'high', ease: 'easy', status: 'new', createdAt: '2026-03-22' },
  { id: 'i3', severity: 'opportunity', stage: 'purchase', title: 'Purchase CVR 상승 기회',
    ...
    action: '소재 전체 적용', actionHref: '/smarcomm/dashboard/creative', impact: 'medium', ease: 'easy', status: 'in_progress', createdAt: '2026-03-21' },
  { id: 'i4', severity: 'suggestion', stage: 'awareness', title: '네이버 SA 키워드 확장 제안',
    ...
    action: '캠페인 수정', actionHref: '/smarcomm/dashboard/campaigns', impact: 'medium', ease: 'easy', status: 'new', createdAt: '2026-03-21' },
  { id: 'i5', severity: 'suggestion', stage: 'advocacy', title: 'NPS 상승 — 리뷰 캠페인 추천',
    ...
    action: '이메일 자동화', actionHref: '/smarcomm/dashboard/crm/email', impact: 'low', ease: 'easy', status: 'new', createdAt: '2026-03-20' },
  { id: 'i6', severity: 'warning', stage: 'interest', title: 'Meta 광고 CTR 하락',
    ...
    action: '소재 제작', actionHref: '/smarcomm/dashboard/creative', impact: 'medium', ease: 'medium', status: 'new', createdAt: '2026-03-20' },
];
