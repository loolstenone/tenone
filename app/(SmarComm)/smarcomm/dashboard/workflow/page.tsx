...
const modules = [
  { name: "콘텐츠 파이프라인", description: "소재 제작 파이프라인을 단계별로 추적합니다.", href: "/smarcomm/dashboard/workflow/pipeline", icon: GitBranch },
  { name: "칸반 보드", description: "드래그앤드롭으로 태스크를 관리합니다.", href: "/smarcomm/dashboard/workflow/kanban", icon: KanbanSquare },
  { name: "프로젝트", description: "캠페인별 프로젝트 진행 현황을 관리합니다.", href: "/smarcomm/dashboard/workflow/projects", icon: FolderKanban },
  { name: "자동화", description: "자동화 규칙을 설정하고 관리합니다.", href: "/smarcomm/dashboard/workflow/automation", icon: Zap },
];
    ...
    <div className="max-w-5xl">
      ...
      <div className="mt-6 rounded-2xl border border-border bg-white">
        <div className="px-5 py-3 border-b border-border flex items-center justify-between">
          ...
          <Link href="/smarcomm/dashboard/workflow/kanban" className="text-xs text-text-muted hover:text-text">전체 보기 →</Link>
        </div>
