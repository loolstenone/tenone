...
| 항목 | 내용 |
|------|------|
| **Phase** | Beta (2026-04-20) — 전체 리디자인 완료. Phase 2 진행 예상 (4주). |
| **개발 수준** | 클럽 시스템·대회 기능·지원서 완성. 포트폴리오 시스템 구축 중. |
| **이월 작업** | M2-C: `/member/projects` 참여 프로젝트 목록 / M2-E: 공개 포트폴리오 페이지 |
| **자산 대기** | 동아리 로고 7종 (M1-G) / MADzine 실제 콘텐츠 이관 (ML-E) |
| **최근 결정** | 큰 글씨·여백·다크 테마 전체 반영 / Clubs 2컬럼 레이아웃 / Hero DAMbe 캐릭터 |
