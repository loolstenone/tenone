    ...
    <div className="bg-[var(--mad-black,#000)] text-white">
      <section className="relative overflow-hidden border-b border-neutral-900">
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-20">
          ...
          <h1 className="mt-3 text-4xl sm:text-6xl font-black tracking-tight">72시간의 열정</h1>
          <p className="mt-6 text-2xl sm:text-3xl font-black text-[#FFC000]">Marketing + Hacking + Marathon</p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          ...
          <div key={c.title} className="bg-neutral-950 border border-neutral-900 p-10">
            <c.icon className="h-8 w-8 text-[#FFC000]" />
