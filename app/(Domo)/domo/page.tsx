            ...
            <section className="py-20 px-6">
                <div className="mx-auto max-w-5xl">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <Link href="/domo/events" className="text-sm text-[#7F1146] hover:text-[#5C0C33] font-medium flex items-center gap-1 transition-colors">
                            전체 보기 <ChevronRight className="h-4 w-4" />
                        </Link>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {upcomingEvents.map((ev, i) => (
                            <Link key={i} href="/domo/events" className="group border border-neutral-200 rounded-xl p-5 hover:border-[#7F1146]/30 hover:shadow-md transition-all">
            ...
            <section className="py-20 px-6">
                <div className="mx-auto max-w-5xl">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <Link href="/domo/insights" className="text-sm text-[#7F1146] hover:text-[#5C0C33] font-medium flex items-center gap-1 transition-colors">
                            전체 보기 <ChevronRight className="h-4 w-4" />
                        </Link>
                    </div>
                    <div className="border-t border-neutral-900 pt-4 space-y-0">
                        {insights.map((post, i) => (
                            <Link key={i} href="/domo/insights" className="block py-4 border-b border-neutral-200 group">
