        ...
        <div className="bg-[#0A0A0A]">
            <section className="py-20 sm:py-28 px-6">
                <div className="mx-auto max-w-4xl text-center">
                    ...
                    <p className="text-neutral-400 text-lg max-w-2xl mx-auto">
                        Mindle은 Ten:One&trade; Universe의 AI 트렌드 분석 플랫폼입니다.
                        수백만 개의 데이터 포인트에서 트렌드 신호를 포착하고,
                        AI와 전문가가 함께 만든 인사이트를 매일 전달합니다.
                    </p>
                </div>
            </section>
            ...
            <section className="py-16 px-6">
                <div className="mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        { icon: Database, title: "수집", sub: "Collect", desc: "카카오 오픈채팅, 커뮤니티, 뉴스, 디스코드 — 수백만 개의 데이터 포인트를 실시간으로 크롤링합니다." },
                        { icon: Brain, title: "분석", sub: "Analyze", desc: "AI가 패턴을 발견하고 키워드를 추출합니다. 크로스 플랫폼 분석으로 진짜 트렌드를 감지합니다." },
                        { icon: Lightbulb, title: "전달", sub: "Deliver", desc: "전문가가 맥락을 더하고 원시 데이터를 실행 가능한 인사이트로 정제해 매일 전달합니다." },
                    ].map((v, i) => (
