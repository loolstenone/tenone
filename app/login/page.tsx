...
function LoginForm() {
    ...
    // SmarComm 도메인이면 SmarComm 로그인
    if (isSmarComm) {
        const scHandleGoogle = () => {
        ...
        const scHandleSubmit = async (e: React.FormEvent) => {
            e.preventDefault();
            setError('');
            try {
            ...
            <>
                ...
                <main className="flex min-h-screen items-center justify-center px-5 pt-14">
                    <div className="w-full max-w-sm">
                        ...
                        <form onSubmit={scHandleSubmit} className="space-y-4">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="space-y-2">
                                <button onClick={scHandleGoogle} className="w-full flex items-center justify-center gap-2 border border-neutral-200 py-2.5 text-sm font-medium text-neutral-700 hover:bg-neutral-50">
                                ...
                                <button onClick={scHandleKakao} className="w-full flex items-center justify-center gap-2 bg-[#FEE500] py-2.5 text-sm font-medium text-[#191919] hover:bg-[#FDD800]">
