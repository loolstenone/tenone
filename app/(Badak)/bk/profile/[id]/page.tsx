  ...
  if (!profile) {
    return (
      <div className="flex min-h-[calc(100vh-56px)] flex-col items-center justify-center">
        ...
        <Link href="/explore" className="mt-3 text-sm text-blue-600 hover:underline">탐색으로 돌아가기</Link>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-[calc(100vh-56px)] bg-neutral-50">
      <div className="mx-auto max-w-2xl px-4 py-8">
        ...
        <div className="mt-6">
          {isOwn ? (
            <Link href="/my" className="inline-flex items-center gap-2 rounded-lg border border-neutral-200 px-5 py-2.5 text-sm font-medium text-neutral-700 hover:bg-neutral-50">
              프로필 수정
            </Link>
          ) : connStatus === 'accepted' ? (
