    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[#1a1a2e] text-white">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-24 md:py-32 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link href="/join" className="flex items-center gap-2 rounded-lg bg-blue-600 px-8 py-3.5 text-sm font-bold text-white hover:bg-blue-700 transition-colors">
              바닥 프로필 만들기 <ArrowRight size={16} />
            </Link>
            <Link href="/explore" className="flex items-center gap-2 rounded-lg border border-white/20 px-8 py-3.5 text-sm font-medium text-white hover:bg-white/10 transition-colors">
              바닥 탐색하기
            </Link>
          </div>
        </div>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-4xl px-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/stars" className="text-sm text-blue-600 hover:underline">전체 보기</Link>
            </div>
            <div className="grid gap-4 md:grid-cols-3">
              {stars.map(star => (
      ...
      <section className="bg-neutral-50 py-16">
        <div className="mx-auto max-w-lg px-6 text-center">
          ...
          <Link href="/join" className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-8 py-3.5 text-sm font-bold text-white hover:bg-blue-700 transition-colors">
