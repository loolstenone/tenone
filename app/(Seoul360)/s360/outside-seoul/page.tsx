                ...
                <div className="bg-white rounded-lg p-6 shadow-sm space-y-8">
                    <div>
                        ...
                        <div className="flex gap-4 text-sm text-blue-600">
                            <Link href="/s360" className="hover:underline">First Plan</Link>
                            <span className="text-neutral-300">|</span>
                            <Link href="/s360" className="hover:underline">Do you know...?</Link>
                        </div>
                    </div>
                    ...
                    <div>
                        <h3 className="font-semibold text-base mb-2 flex items-center gap-2">
                            ...
                            Seoul 360° Tour by{" "}
                            <Link href="/s360/subway-line" className="underline">Subway Line</Link>
                        </h3>
                        <div className="flex flex-wrap gap-x-3 gap-y-1 text-sm">
                            {subwayLines.map((line, i) => (
                                <span key={line}>
                                    <Link href="/s360/subway-line" className="text-blue-600 hover:underline">{line}</Link>
                    ...
                    <div>
                        <h3 className="font-semibold text-base mb-2 flex items-center gap-2">
                            ...
                            Seoul 360° Tour by{" "}
                            <Link href="/s360/district" className="underline">District</Link>
                        </h3>
                        <div className="flex flex-wrap gap-x-1 gap-y-1 text-sm">
                            {districts.map((d, i) => (
                                <span key={d}>
                                    <span className="text-neutral-400 text-xs mr-0.5">{i + 1}.</span>
                                    <Link href="/s360/district" className="text-blue-600 hover:underline">{d}</Link>
