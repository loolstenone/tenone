                ...
                <div className="bg-white rounded-lg p-6 shadow-sm space-y-8">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 text-sm text-blue-600">
                            <Link href="/seoul360" className="hover:underline">
                                First Plan
                            </Link>
                    ...
                    <div>
                        <h3 className="font-semibold text-base mb-2 flex items-center gap-2">
                            ...
                            Seoul 360° Tour by{" "}
                            <Link href="/seoul360/subway-line" className="underline">
                                Subway Line
                            </Link>
                        </h3>
                    ...
                    <div>
                        <h3 className="font-semibold text-base mb-2 flex items-center gap-2">
                            ...
                            Seoul 360° Tour by{" "}
                            <Link href="/seoul360/district" className="underline">
                                District
                            </Link>
                        </h3>
                    ...
                    <div>
                        <h3 className="font-semibold text-base mb-2 flex items-center gap-2">
                            <Navigation className="h-4 w-4 text-[#F5C518]" />
                            Seoul 360° Tour by{" "}
                            <Link href="/seoul360/outside-seoul" className="underline">
                                Outside Seoul
                            </Link>
                        </h3>
                        <div className="flex gap-3 text-sm text-blue-600">
                            <Link href="/seoul360/outside-seoul" className="hover:underline">
                                KTX
                            </Link>
                            <span className="text-neutral-300">|</span>
                            <Link href="/seoul360/outside-seoul" className="hover:underline">
