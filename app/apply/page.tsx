        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-3xl mx-auto px-6 py-12">
                <form onSubmit={handleSubmit} className="border border-neutral-200 p-8">
                    ...
                    <p className="text-xs text-neutral-400 mb-8">검토 후 초대 링크를 이메일로 보내드립니다.</p>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input value={name} onChange={e => setName(e.target.value)} placeholder="홍길동"
                                className="w-full px-4 py-2.5 text-sm border border-neutral-200 focus:outline-none focus:border-neutral-400" />
                        </div>
                        <div>
                    ...
                    <div className="mb-6">
                        ...
                        {type === "student" && (
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    <label className="block text-[10px] text-neutral-400 mb-1">학교 / 학과</label>
                                    <input value={position} onChange={e => setPosition(e.target.value)} placeholder="OO대학교 마케팅학과"
                    ...
                    <div className="mb-8">
                        ...
                        <textarea value={message} onChange={e => setMessage(e.target.value)}
                            ...
                            rows={4} className="w-full px-4 py-2.5 text-sm border border-neutral-200 resize-none focus:outline-none focus:border-neutral-400" />
                    </div>
