...
const faqItems: FaqItem[] = [
    // ── FAQ (기존) ──
    {
        ...
        link: { text: "VRIEF & GPR 교육 페이지", href: "/education" },
    },
    {
        ...
        link: { text: "GPR 작성 템플릿 보기", href: "/library" },
    },
    {
    ...
    },
    {
        ...
        link: { text: "핸드북 - 휴가 정책", href: "/handbook" },
    },
    {
    ...
    },
    {
        ...
        link: { text: "온보딩 가이드", href: "/onboarding" },
    },
    ...
    },
    {
        ...
        link: { text: "VRIEF 템플릿 다운로드", href: "/library" },
    },
    {
...
export default function FaqPage() {
    ...
    return (
        <div>
            <div className="mb-6">
                <h1 className="text-lg font-bold">FAQ & 업무 가이드</h1>
                <p className="text-xs text-neutral-400 mt-1">자주 묻는 질문과 업무별 가이드를 한곳에 모았습니다</p>
            </div>
