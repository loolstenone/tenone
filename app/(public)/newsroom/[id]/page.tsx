        ...
        return (
            <div className="bg-white text-neutral-900 min-h-screen pt-32 px-6">
                <div className="max-w-3xl mx-auto text-center py-20">
                    ...
                    <Link href="/newsroom" className="text-sm text-neutral-900 hover:underline inline-flex items-center gap-2">
        ...
        <div className="bg-white text-neutral-900">
            <article className="pt-28 pb-32 px-6">
                <div className="max-w-3xl mx-auto">
                    <Link href="/newsroom" className="inline-flex items-center gap-2 text-sm text-neutral-400 hover:text-neutral-900 transition-colors mb-8">
                    ...
                    <div className="mt-16 pt-8 border-t border-neutral-100">
                        <Link href="/newsroom" className="inline-flex items-center gap-2 text-sm text-neutral-400 hover:text-neutral-900 transition-colors">
