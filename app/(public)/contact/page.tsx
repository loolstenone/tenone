        ...
        <div className="bg-white text-neutral-900">
            ...
            <section className="pt-32 pb-16 px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mt-6 text-lg text-neutral-500 max-w-2xl space-y-1">
            ...
            <section className="max-w-7xl mx-auto px-6 pb-32 grid lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-4 space-y-8">
                    <div className="border border-neutral-200 p-6">
                        ...
                        <p className="text-sm text-neutral-400 mt-4">Planning, Business, Marketing, Advertising, Communication, HR</p>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h4 className="text-sm font-medium">
                                    <span className="line-through text-neutral-400">Office</span>{" "}
                                    <span className="font-bold text-neutral-900">Onice</span>
                                </h4>
                                <p className="text-sm text-neutral-500 mt-1">Tenone.biz</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex border-b border-neutral-200 mb-8">
                        <button onClick={() => setActiveTab('partner')}
                            className={clsx(
                                ...
                                activeTab === 'partner' ? "border-neutral-900 text-neutral-900 font-medium" : "border-transparent text-neutral-400 hover:text-neutral-700"
                            )}>
                        ...
                        <button onClick={() => setActiveTab('signup')}
                            className={clsx(
                                "flex items-center gap-2 px-6 py-3 text-sm tracking-wide transition-colors border-b-2",
                                activeTab === 'signup' ? "border-neutral-900 text-neutral-900 font-medium" : "border-transparent text-neutral-400 hover:text-neutral-700"
                            )}>
                    ...
                    {activeTab === 'partner' && (
                        <form className="space-y-6">
                            <div className="mb-6">
                                ...
                                <p className="text-sm text-neutral-500 mt-1">Ten:One™의 파트너가 되어 함께 문제를 해결해요.</p>
                            </div>
                    ...
                    {activeTab === 'signup' && (
                        <div className="space-y-6">
                            <div className="mb-6">
                                ...
                                <p className="text-sm text-neutral-500 mt-1">Ten:One™ 사이트의 멤버로 가입하고 다양한 소식을 받아보세요.</p>
                            </div>

                            <div className="border border-neutral-200 p-8 text-center">
                                <div className="w-16 h-16 bg-neutral-100 rounded-full flex items-center justify-center mx-auto mb-6">
                                    {isAuthenticated ? <CheckCircle className="h-7 w-7 text-green-500" /> : <UserPlus className="h-7 w-7 text-neutral-400" />}
                                </div>
                                {isAuthenticated ? (
                                    <>
                            ...
                            <div className="bg-neutral-50 border border-neutral-100 p-6">
                                ...
                                <ul className="space-y-2 text-sm text-neutral-500">
                                    <li className="flex items-start gap-2"><span className="text-neutral-300 mt-0.5">·</span> Newsroom 및 Works 최신 소식 알림</li>
                                    <li className="flex items-start gap-2"><span className="text-neutral-300 mt-0.5">·</span> MAD League, Badak 등 이벤트 우선 초대</li>
                                    <li className="flex items-start gap-2"><span className="text-neutral-300 mt-0.5">·</span> Ten:One™ 뉴스레터 구독</li>
                                    <li className="flex items-start gap-2"><span className="text-neutral-300 mt-0.5">·</span> 파트너 전환 시 우대</li>
                                </ul>
                            </div>
                        </div>
                    )}
