        ...
        <div className="max-w-2xl mx-auto py-8">
                        ...
                        {subscribeNewsletter ? (
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-neutral-400 mt-1.5">수신 이메일: <span className="font-medium text-neutral-600">{user.email}</span></p>
                                    <button type="button" onClick={() => setSubscribeNewsletter(false)}
                                        className="mt-3 text-xs text-neutral-400 hover:text-red-500 transition-colors underline underline-offset-2">
                                        구독 해지
                                    </button>
                                </div>
                            </div>
            ...
            {showPasswordModal && (
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="bg-white rounded-2xl border border-neutral-200 w-full max-w-sm p-6 shadow-lg">
                        ...
                        <p className="text-xs text-neutral-500 mb-4">프로필 수정을 위해 현재 비밀번호를 입력해주세요.</p>
                        <div className="relative mb-3">
                            <input
                                ...
                                placeholder="비밀번호 입력"
                                autoFocus
                                className="w-full border border-neutral-200 px-4 py-2.5 text-sm rounded focus:border-neutral-900 focus:outline-none pr-10"
                            />
                        ...
                        <div className="flex gap-2">
                            <button onClick={() => setShowPasswordModal(false)}
                                className="flex-1 px-4 py-2 text-sm border border-neutral-200 rounded text-neutral-500 hover:border-neutral-400 transition-colors">
                                취소
                            </button>
