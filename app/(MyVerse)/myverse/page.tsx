        ...
        <section className="py-24 lg:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="text-center mt-10">
                    <Link href="/myverse/philosophy" className="text-sm text-indigo-400 hover:text-indigo-300 transition-colors inline-flex items-center gap-1">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <Link href="/myverse/service" className="mt-8 text-sm text-indigo-400 hover:text-indigo-300 transition-colors inline-flex items-center gap-1">
