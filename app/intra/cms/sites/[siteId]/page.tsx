...
import type { CmsBoard, BoardType, SkinType, BoardVisibility } from "@/types/cms";
import {
...
export default function SiteDetailPage({ params }: { params: Promise<{ siteId: string }> }) {
    ...
    const { getSiteById, getBoardsBySite, boardPosts, addBoard } = useCms();
    ...
    return (
        <div className="max-w-5xl">
            {/* Back */}
            <button
                onClick={() => router.push("/intra/cms/sites")}
                                ...
                                <div className="border-t border-neutral-100">
                                    ...
                                    <div className="px-4 py-2 bg-neutral-50/50 flex items-center justify-between">
                                        ...
                                        <div className="flex gap-2">
                                            <Link
                                                href={`/intra/cms/sites/${siteId}/boards/${board.id}`}
                                                className="text-xs text-neutral-500 hover:text-neutral-900 underline"
                                            >
                                                게시글 관리
                                            </Link>
                                            <Link
                                                href={`/intra/cms/sites/${siteId}/boards/${board.id}/settings`}
                ...
                {showAddBoard && (
                    <div className="border border-neutral-300 bg-white p-4">
                        ...
                        <div className="flex items-center justify-between">
                            <Link
                                href={`/intra/cms/sites/${siteId}/boards/new`}
                                className="text-xs text-neutral-400 hover:text-neutral-900 underline"
                            >
                                상세 설정으로 만들기
                            </Link>
