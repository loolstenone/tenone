...
export default function CmsDashboard() {
    const { sites, boards, boardPosts } = useCms();
    ...
    const stats = [
        { name: "전체 사이트", value: sites.length, icon: Globe, href: "/intra/cms/sites" },
        { name: "게시판 수", value: totalBoards, icon: LayoutGrid, href: "/intra/cms/sites" },
        { name: "게시글 수", value: totalPosts, icon: FileText, href: "/intra/cms/sites" },
        { name: "오늘 조회수", value: todayViews.toLocaleString(), icon: Eye, href: "/intra/cms/sites" },
    ];
        ...
        <div className="space-y-8">
            ...
            <div>
                <div className="flex items-center justify-between mb-4">
                    ...
                    <Link href="/intra/cms/sites" className="text-xs text-neutral-400 hover:text-neutral-900">
                        전체 보기
                    </Link>
                </div>
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {sites.map(site => {
                        ...
                        return (
                            <Link key={site.id} href={`/intra/cms/sites/${site.id}`}
