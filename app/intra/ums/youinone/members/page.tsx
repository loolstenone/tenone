...
export default function YouInOneMembersPage() {
    ...
    useEffect(() => {
        createClient().from("members")
            ...
            .contains("affiliations", ["youinone"])
    ...
    return (
        <div>
            <div className="mb-6">
                ...
                <p className="text-sm text-neutral-400 mt-0.5">YouInOne 승인 크루 관리</p>
            </div>
            <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="border border-neutral-200 rounded-lg p-4">
                    <p className="text-xs text-neutral-400 mb-1">전체 크루</p>
            ...
            {loading ? (
                ...
                <div className="border border-neutral-200 rounded-lg p-12 text-center">
                    ...
                    <p className="text-sm text-neutral-400">{search ? "검색 결과 없음" : "크루가 없습니다"}</p>
                </div>
            ) : (
