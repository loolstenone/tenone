        ...
        return (
            <div className="h-full bg-black flex items-center justify-center px-4">
                <div className="text-center max-w-md">
                    ...
                    <button onClick={() => router.push('/')} className="px-6 py-2.5 rounded-lg bg-zinc-800 text-sm text-white hover:bg-zinc-700 transition-colors">홈으로 돌아가기</button>
                </div>
            </div>
        );
    }

    return <div className="h-full bg-black"><StudioShell>{children}</StudioShell></div>;
}
