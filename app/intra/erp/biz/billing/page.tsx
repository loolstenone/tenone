    ...
    return (
        <div className="max-w-5xl">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h1 className="text-2xl font-bold mb-1">사업 청구관리</h1>
                    <p className="text-sm text-neutral-500">프로젝트 기반 청구 대상을 관리합니다.</p>
                </div>
                <div className="flex gap-2">
                    <Link href="/intra/erp/biz/billing/payment" className="flex items-center gap-1.5 px-3 py-2 text-xs border border-neutral-200 hover:border-neutral-400 transition-colors">
                        지급관리 →
                    </Link>
