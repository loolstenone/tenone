...
import { Search, Check, Loader2, Crown, FileText } from "lucide-react";
...
export default function IntraPlannersPage() {
    const [tab, setTab] = useState<"subscribers" | "payments">("subscribers");
    ...
    return (
        <div className="p-6 space-y-6">
            <PageHeader
                ...
                description="구독자 · 결제 · PDF 구매자 활성화 관리"
            />
                ...
                <div className="flex gap-0">
                    <button
                        ...
                        className={`px-4 py-3 text-sm border-b-2 -mb-px transition-colors ${
                            tab === "subscribers" ? "border-[#0F766E] text-white font-semibold" : "border-transparent text-neutral-400 hover:text-white"
                        }`}
                    >
                        구독자 ({subs.length})
                    </button>
                    <button
                        ...
                        className={`px-4 py-3 text-sm border-b-2 -mb-px transition-colors ${
                            tab === "payments" ? "border-[#0F766E] text-white font-semibold" : "border-transparent text-neutral-400 hover:text-white"
                        }`}
                    >
                        결제 ({pays.length})
                    </button>
