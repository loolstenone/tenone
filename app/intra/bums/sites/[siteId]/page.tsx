    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mb-3">
                <h2 className="text-sm font-semibold">게시판 ({siteBoards.length})</h2>
                <button
            ...
            <div className="space-y-2 mb-6">
                ...
                {showAddBoard && (
                    <div className="border border-neutral-300 bg-white p-4">
                        <div className="flex items-center justify-between mb-3">
                            <h3 className="text-xs font-semibold">게시판 추가</h3>
            ...
            {/* Recent Activity */}
            <div>
                <h2 className="text-sm font-semibold mb-3">최근 활동</h2>
