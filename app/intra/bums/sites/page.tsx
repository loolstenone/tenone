        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6">
                ...
                <div className="space-y-3">
                    ...
                    <div className="border border-neutral-200 bg-white max-h-[600px] overflow-y-auto divide-y divide-neutral-100">
                        {filtered.map(site => {
                            ...
                            return (
                                <button
                                    ...
                                    className={clsx(
                                        ...
                                        selectedSite === site.id ? "bg-neutral-50 border-l-2 border-neutral-900" : "hover:bg-neutral-50"
                                    )}
                                >
                ...
                {sel && selectedSite ? (
                    <div className="space-y-5">
                        {/* 사이트 헤더 */}
                        <div className="border border-neutral-200 bg-white p-5 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <a href={`https://${sel.domain}`} target="_blank" rel="noopener noreferrer"
                                        className="text-xs text-neutral-400 hover:text-neutral-900 flex items-center gap-1">
                        ...
                        <div className="border border-neutral-200 bg-white p-5 space-y-4">
                            ...
                            <div>
                                <label className="text-xs font-medium text-neutral-500 uppercase block mb-1">메타 타이틀</label>
                                <input value={editSeo.title} onChange={e => setEditSeo(p => ({ ...p, title: e.target.value }))}
                                    className="w-full border border-neutral-200 px-4 py-2.5 text-sm focus:border-neutral-900 focus:outline-none bg-white" />
                            </div>
                            <div>
                                <label className="text-xs font-medium text-neutral-500 uppercase block mb-1">메타 설명</label>
                                <textarea value={editSeo.description} onChange={e => setEditSeo(p => ({ ...p, description: e.target.value }))}
                                    rows={2} className="w-full border border-neutral-200 px-4 py-2.5 text-sm focus:border-neutral-900 focus:outline-none bg-white resize-y" />
                            </div>
                            <div>
                                <label className="text-xs font-medium text-neutral-500 uppercase block mb-1">키워드</label>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="text-xs font-medium text-neutral-500 uppercase block mb-1">SEO 점수</label>
                                    <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <label className="text-xs font-medium text-neutral-500 uppercase block mb-1">GEO 점수</label>
                                    <div className="flex items-center gap-2">
                                        <div className="flex-1 h-2 bg-neutral-100 rounded-full overflow-hidden">
                            ...
                            <div className="grid grid-cols-4 gap-3">
                                {[
                                    ...
                                    <div key={c.label} className="flex items-center gap-2">
                                        <div className="w-8 h-8 rounded border border-neutral-200" style={{ backgroundColor: c.color }} />
                                        <div>
                        ...
                        <div className="flex items-center gap-3">
                            <button onClick={handleSave}
                                className="flex items-center gap-2 bg-neutral-900 text-white px-6 py-2.5 text-sm font-medium hover:bg-neutral-800 transition-colors">
                    ...
                    <div className="border border-neutral-200 bg-white flex items-center justify-center py-20">
