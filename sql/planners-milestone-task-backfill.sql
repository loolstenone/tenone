-- ═══════════════════════════════════════════════════════════════
-- 프로젝트 마일스톤 → planners_daily.tasks 백필
...
BEGIN
    FOR m IN
        SELECT
            ...
            p.member_id,
            p.id    AS project_id
        FROM planners_project_milestones ms
        JOIN planners_projects p ON p.id = ms.project_id
    ...
    LOOP
        ...
        IF v_existing IS NULL THEN
            ...
            INSERT INTO planners_daily (member_id, date, tasks)
