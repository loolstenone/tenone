...
CREATE TABLE IF NOT EXISTS planners_push_subscriptions (
...
CREATE INDEX IF NOT EXISTS idx_planners_push_member ON planners_push_subscriptions(member_id);

ALTER TABLE planners_push_subscriptions ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "본인만" ON planners_push_subscriptions;
CREATE POLICY "본인만" ON planners_push_subscriptions
