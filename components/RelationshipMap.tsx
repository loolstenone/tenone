...
export function RelationshipMap({ nodes, links }: Props) {
    ...
    return (
        <div className="w-full h-[600px] border border-neutral-200 rounded-xl bg-neutral-50 relative overflow-hidden">
                ...
                {links.map((link, i) => {
                    ...
                    return (
                        <g key={i}>
                            ...
                            />
                            <text x={midX} y={midY} textAnchor="middle" dy="-5" fontSize="10" fill="#737373">
                                {link.label}
                            </text>
                        </g>
                    );
                        ...
                        >
                            <circle
                                ...
                                className={clsx(
                                    ...
                                    node.group === 'Core' ? "fill-neutral-900 stroke-indigo-500 stroke-4" :
            ...
            <div className="absolute bottom-4 right-4 bg-white/90 px-4 py-2 rounded-lg border border-neutral-200 text-xs text-neutral-500">
                <div className="flex items-center gap-2 mb-1">
                    <span className="w-2 h-2 rounded-full border-2 border-indigo-500 bg-neutral-900"></span> Core
                </div>
