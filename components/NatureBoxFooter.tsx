...
export function NatureBoxFooter() {
    return (
        <footer className="bg-[#2D3319] text-neutral-400">
            <div className="border-b border-neutral-700/50">
                <div className="mx-auto max-w-6xl px-6 lg:px-8 py-12">
                    ...
                    <p className="text-sm mb-6">
                        <a href="https://www.tenone.biz" target="_blank" rel="noopener noreferrer" className="text-[#6B8E23] hover:text-[#8FBC8F] transition-colors">
                            www.tenone.biz
                        </a>
                    </p>
                    <div className="flex flex-wrap gap-3">
                        {universeProjects.map((item) => (
                            <a
                                ...
                                className="text-xs px-3 py-1.5 rounded-full border border-neutral-700 hover:border-[#6B8E23] hover:text-[#8FBC8F] transition-colors"
                            >
                                {item.name}
                            </a>
                        ))}
            ...
            <div className="mx-auto max-w-6xl px-6 lg:px-8 py-10">
                ...
                <div className="mt-10 pt-6 border-t border-neutral-700 text-center text-xs">
                    &copy; Nature Box. Powered by <a href="/about?tab=universe" className="hover:text-white transition-colors underline">Ten:One&trade; Universe</a>.
                </div>
            </div>
        </footer>
    );
