        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative w-full max-w-lg rounded-2xl border border-neutral-200 bg-white p-6 shadow-2xl mx-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm text-neutral-500 mb-1">Brand</label>
                            <select
                                value={form.brandId}
                        ...
                        <div>
                            <label className="block text-sm text-neutral-500 mb-1">Assignee</label>
                            <input
                                value={form.assignee}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm text-neutral-500 mb-1">Due Date</label>
                            <input
                                type="date"
                                value={form.dueDate}
                        ...
                        <div>
                            <label className="block text-sm text-neutral-500 mb-1">Tags (comma separated)</label>
                            <input
                                value={form.tags}
