...
const MENU_KEYWORDS: Record<string, string[]> = {
  ...
  '/sc/dashboard/funnel': ['퍼널', '퍼널 분석', '전환', '이탈', '전환율', 'Awareness', 'Interest', 'Consideration', 'Purchase', 'Retention', 'Advocacy', '병목', '건강도'],
  '/sc/dashboard/scan': ['GEO', 'SEO', '진단', '검색', 'AI', '스키마', '크롤링', '점수', 'Index'],
  '/sc/dashboard/traffic': ['트래픽', '유입', '채널', 'GA4', '세션', '사용자', 'AI 추천', '오디언스', '디바이스', '페이지'],
  '/sc/dashboard/analytics': ['매출', '분석', 'ROAS', 'ROI', '수익', '광고비', '추이'],
  '/sc/dashboard/reports': ['보고서', '리포트', '성과', '채널', '캠페인', 'KPI', 'CPA'],
  '/sc/dashboard/data-reports': ['데이터', '리포트', '통합', '분석', '커스텀', '템플릿', '업종', '프리셋'],
  // AI 가시성
  '/sc/dashboard/geo': ['AI 가시성', 'GEO', '멘션', 'ChatGPT', 'Perplexity', 'Gemini', 'Claude', '브랜드', '프롬프트'],
  '/sc/dashboard/geo/competitors': ['경쟁사', 'AI 가시성', '리서치', '비교', '점수'],
  '/sc/dashboard/geo/prompts': ['프롬프트', '리서치', '검색', '멘션', '포지션', 'AI'],
  '/sc/dashboard/geo/brand': ['브랜드', '인식', '감성', '내러티브', '실적', 'NPS'],
  '/sc/dashboard/geo/tracking': ['프롬프트', '추적', '모니터링', '포지션', '변화'],
  // 액션팩
  '/sc/dashboard/creative': ['소재', '카피', '배너', '크리에이티브', 'A/B', 'CTR', '제작', 'AI'],
  '/sc/dashboard/content': ['콘텐츠', '주제', 'SEO 최적화', '재활용', '블로그', '채널', '퍼널'],
  '/sc/dashboard/advisor': ['AI 어드바이저', '인사이트', '추천', '액션', '예산', 'Before', 'After', '병목'],
  // CRM팩
  '/sc/dashboard/crm': ['CRM', '고객', '리드', '관리', '파이프라인', '세그먼트'],
  '/sc/dashboard/crm/kakao': ['카카오', '알림톡', '친구톡', '비즈메시지', '발송', 'CRM'],
  '/sc/dashboard/crm/email': ['이메일', '자동화', '드립', '뉴스레터', '발송', '오픈율'],
  '/sc/dashboard/crm/push': ['푸시', '알림', '메시지', '발송', '세그먼트', '클릭'],
  // 실험팩
  '/sc/dashboard/abtest': ['A/B', '테스트', '실험', '전환율', 'CTR', '소재', '유의성', '통계'],
  '/sc/dashboard/journey': ['여정', '고객', '접점', '퍼널', '전환', '타임라인', '이탈'],
  '/sc/dashboard/cohort': ['코호트', '리텐션', '세그먼트', '이탈', '그룹', '히트맵'],
  '/sc/dashboard/events': ['이벤트', '추적', '트래킹', '전환', '데이터', '연동', '매핑'],
  // 운영팩
  '/sc/dashboard/workflow/projects': ['프로젝트', '캠페인', '기획', '관리', 'Phase', '진행률'],
  '/sc/dashboard/workflow/kanban': ['칸반', '태스크', '보드', '관리', '드래그', '우선순위'],
  '/sc/dashboard/calendar': ['캘린더', '일정', '시즌', '스케줄', '기획', '이벤트'],
  '/sc/dashboard/workflow/pipeline': ['파이프라인', '콘텐츠', '제작', '아이디어', '발행'],
  '/sc/dashboard/archive': ['아카이브', '소재', '보관', '라이브러리', '캠페인'],
  // 집행팩
  '/sc/dashboard/campaigns': ['캠페인', '광고', '집행', '네이버', '메타', '구글', 'ROAS', 'CPA', '전환'],
  '/sc/dashboard/workflow/automation': ['자동화', '트리거', '규칙', '워크플로우', '액션', '조건'],
  // 설정
  '/sc/dashboard/admin': ['관리', '블로그', 'SEO', '사이트', '설정', 'CMS', '회원', '페이지'],
  '/sc/dashboard/workflow': ['워크플로우', '현황', '태스크', '파이프라인', '프로젝트', '자동화'],
  '/sc/dashboard/profile': ['설정', '워크스페이스', '멤버', '연동', '팔레트', 'OAuth', 'API'],
  '/sc/dashboard/members': ['멤버', '권한', '역할', '초대', '관리자'],
  '/sc/dashboard/glossary': ['용어', '사전', '마케팅', '검색', '카테고리'],
  '/sc/dashboard/guide': ['가이드', '사용법', '시작', '도움말'],
};
