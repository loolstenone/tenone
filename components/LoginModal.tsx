...
interface LoginModalProps {
    isOpen: boolean;
    onClose: () => void;
    /** 브랜드 악센트 컬러 (기본: #171717) */
    accentColor?: string;
}

export function LoginModal({ isOpen, onClose, accentColor = "#171717" }: LoginModalProps) {
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
            ...
            <div className="relative z-10 w-full max-w-md mx-4 bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="px-6 pb-6">
                    <p className="text-sm text-neutral-500 mb-5">계정에 로그인하세요</p>
                    ...
                    <div className="space-y-2.5 mb-5">
                        ...
                        >
                            <svg className="w-4.5 h-4.5" viewBox="0 0 24 24"><path d="M12 3C6.48 3 2 6.36 2 10.44c0 2.62 1.74 4.93 4.36 6.24l-1.1 4.06c-.1.36.3.65.62.45l4.84-3.2c.42.04.85.06 1.28.06 5.52 0 10-3.36 10-7.5S17.52 3 12 3z" fill="#3C1E1E"/></svg>
                            카카오로 로그인
                        </button>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        <div>
                            <input
                                ...
                                className="w-full px-4 py-2.5 border border-neutral-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-400"
                                required
                            />
                        </div>
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-2.5 border border-neutral-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-400 pr-10"
                                required
                            />
                            <button
                                type="button"
                    ...
                    <p className="text-center text-sm text-neutral-500 mt-4">
                        계정이 없으신가요?{" "}
                        <a href="/signup" className="font-semibold text-neutral-900 hover:underline">
                            회원가입
                        </a>
                    </p>
                </div>
