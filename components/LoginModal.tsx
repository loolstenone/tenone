                ...
                <div className="flex items-center justify-between px-6 pt-5 pb-2">
                    <div className="flex gap-4">
                        <button onClick={() => switchTab("login")}
                            className={`text-lg font-bold transition-colors ${tab === "login" ? "text-neutral-900" : "text-neutral-500 hover:text-neutral-900"}`}>
                            로그인
                        </button>
                        <button onClick={() => switchTab("signup")}
                            className={`text-lg font-bold transition-colors ${tab === "signup" ? "text-neutral-900" : "text-neutral-500 hover:text-neutral-900"}`}>
                            회원가입
                        </button>
                    </div>
                ...
                <div className="px-6 pb-6">
                    ...
                    <div className="space-y-2.5 mb-5">
                        <button onClick={() => handleSocialLogin("google")}
                            className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 border border-neutral-300 rounded-xl text-sm font-semibold text-neutral-900 hover:bg-neutral-50 transition-colors">
