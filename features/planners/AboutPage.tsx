...
const TIMELINE = [
    ...
    { year: "2018", event: "Planner's Planner 종이 플래너 첫 출시" },
    { year: "2022", event: "디지털 버전 출시 — 굿노트·삼성노트 호환 PDF" },
    { year: "2024", event: "AI 비서 통합 연구 시작 — 능동적 플래너의 개념 수립" },
    { year: "2026", event: "Planner's Planner AI 정식 런칭 — 아침 브리핑, 저녁 회고, 59종 템플릿" },
];
        ...
        <div className="bg-white text-[#1a1a1a] min-h-screen">
            ...
            <section className="px-6 py-16 max-w-2xl mx-auto">
                ...
                <div className="space-y-5 text-neutral-600 leading-relaxed">
                    <p>
                        Planner&apos;s는 22년간 기획 현장에서 반복되는 질문에서 시작했습니다.
                    ...
                    <p>
                        Planner&apos;s Planner는 그 사고 체계를 일상의 도구로 만든 플래너입니다.
            ...
            <section className="px-6 py-16 max-w-2xl mx-auto">
                ...
                <p className="text-sm text-neutral-400 mb-10">Planner&apos;s가 일하는 방식 — 10가지 원칙</p>
