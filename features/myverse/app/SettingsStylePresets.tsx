...
import { applyMyverseTheme, applyMyverseFont, applyMyverseUserFont, applyMyverseThemeMode, applyMyverseRadius, type MyverseThemeMode, type MyverseRadius } from "./MyverseThemeProvider";
...
export type SettingsPreset = {
    ...
    color: string;
    radius: MyverseRadius;
    font: string;
    userFont: string;
    mode: MyverseThemeMode;
};
