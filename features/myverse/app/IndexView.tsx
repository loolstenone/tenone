...
export function IndexView() {
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            const role = settings?.user?.user_role as MyverseRole | null | undefined;
            if (role) {
                setUserRole(role);
        ...
        if (userRole && roleTemplates.length > 0) return (
            <>
                <div className="flex items-center gap-1.5 mb-2.5">
                    ...
                    <span className="text-[10px] font-semibold text-teal-700 uppercase tracking-wide">{MYVERSE_ROLE_META[userRole].label} 추천</span>
                </div>
                <div className="space-y-1.5">
    ...
    return (
        <div ref={swipeRef} className="max-w-6xl mx-auto px-4 md:px-10 py-6 md:py-12">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:gap-3 gap-3 mb-6 md:mb-8">
                ...
                <MyverseUtilityLinks className="sm:ml-auto" />
            </div>
