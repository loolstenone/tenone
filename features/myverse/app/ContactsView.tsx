        ...
        <div className="max-w-6xl mx-auto px-4 md:px-10 py-6 md:py-12">
            ...
            <div className="flex gap-6">
                ...
                {contacts.length > 20 && isCompactView && (
                    <div className="hidden md:flex flex-col items-center fixed right-2 top-1/2 -translate-y-1/2 z-30 bg-white rounded-lg py-2 px-1 shadow-md border border-neutral-200 text-[10px] select-none max-h-[80vh] overflow-y-auto myverse-dark:!bg-white/[0.04] myverse-dark:!border-white/10">
                        {/* All — 전체 보기 */}
                        <button
