 ...
 * 즉시 시각적으로 반영된다. 전부 CSS 변수(--pp-*, --myverse-accent, --myverse-font,
 * --myverse-user-font, html.myverse-dark)를 통해 자동 갱신되므로 별도 props 불필요.
 *
 * 3개 탭: 일간 · 프로젝트 · AI
 */
                    ...
                    <div>
                        <div className="flex items-center gap-1.5">
                            <span
                                ...
                                style={{ color: "var(--pp-ink)", fontFamily: "var(--myverse-user-font, inherit)" }}
                            >
                                2026년 4월 29일
                            </span>
                            <span
                    ...
                    <div key={i} className="flex items-center gap-1.5 text-[13px]">
                        ...
                        <span
                            style={{
                                ...
                                fontFamily: "var(--myverse-user-font, inherit)",
                            }}
                        >
                            {item.text}
                        </span>
                ...
                <div className="space-y-1">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-1 text-[12px]">
                            ...
                            <span style={{ color: "var(--pp-ink-2)", fontFamily: "var(--myverse-user-font, inherit)" }}>
                                5/3(일) 김선아 멘토님 생신
                            </span>
                        </div>
                ...
                {[
                    ...
                    <div key={i} className="flex items-center gap-2 text-[13px]">
                        ...
                        <span
                            ...
                            style={{ color: t.done ? "var(--pp-ink-4)" : "var(--pp-ink-2)", fontFamily: "var(--myverse-user-font, inherit)" }}
                        >
                            {t.text}
                        </span>
                    </div>
