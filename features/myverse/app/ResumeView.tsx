...
import type { MyverseIdentity, ResumeData } from "@/lib/myverse/types";
...
export function ResumeView() {
    const { user } = useAuth();
    const [data, setData] = useState<Partial<MyverseIdentity>>({});
    ...
    async function save(patch: Partial<MyverseIdentity>) {
