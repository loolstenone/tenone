...
import type { MyverseProject, ProjectCollaborator } from "@/lib/myverse/types";
...
export function ProjectDetailView({ projectId }: { projectId: string }) {
    const [project, setProject] = useState<MyverseProject | null>(null);
    ...
    async function saveProject(patch: Partial<MyverseProject>) {
...
function CoverTab({ project, save, userRole }: { project: MyverseProject; save: (p: Partial<MyverseProject>) => void; userRole: "owner" | "editor" | "viewer" }) {
...
function ShareField({ project }: { project: MyverseProject }) {
...
function CollaboratorField({ project, save }: { project: MyverseProject; save: (p: Partial<MyverseProject>) => void }) {
