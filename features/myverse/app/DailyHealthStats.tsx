...
export function DailyHealthStats({ date, version }: { date: string; version?: number }) {
    ...
    return (
        <div className="flex items-center gap-4 px-5 py-2 bg-neutral-50 myverse-dark:bg-white/[0.025] border-b border-neutral-100 myverse-dark:border-white/8 flex-wrap">
            {stats.intakeKcal > 0 && (
