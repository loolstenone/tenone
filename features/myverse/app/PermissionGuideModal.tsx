...
export function PermissionGuideModal({ open, onClose, onRetry, permission, onGranted }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-[200] bg-black/60 flex items-end sm:items-center justify-center p-0 sm:p-4">
            <div className="bg-white myverse-dark:bg-white/[0.03] w-full sm:max-w-md sm:rounded-xl rounded-t-2xl border border-neutral-200 myverse-dark:border-white/8 shadow-xl max-h-[90vh] flex flex-col">
                {/* 헤더 */}
                <div className="flex items-start justify-between p-5 pb-3 border-b border-neutral-100 myverse-dark:border-white/8">
                    <div>
                    ...
                    <button
                        onClick={onClose}
                        className="p-1 rounded hover:bg-neutral-100 myverse-dark:hover:bg-white/[0.06] text-neutral-400 transition-colors"
                        aria-label="닫기"
                    >
                        <X className="h-4 w-4" />
                    </button>
                ...
                <div className="flex-1 overflow-y-auto p-5 space-y-4">
                    {/* 감지된 기기·브라우저 칩 + 수동 변경 */}
                    <div className="border border-neutral-200 myverse-dark:border-white/8 rounded-lg p-3">
                        <div className="flex items-center justify-between gap-2">
                            ...
                            <button
                                ...
                                className="shrink-0 flex items-center gap-1 text-[10px] text-neutral-500 myverse-dark:text-neutral-400 hover:text-[#6366F1] transition-colors px-2 py-1 rounded border border-neutral-200 myverse-dark:border-white/8"
                            >
                                다른 브라우저인가요?
                        ...
                        {showPicker && (
                            <div className="mt-3 pt-3 border-t border-neutral-100 myverse-dark:border-white/8 grid grid-cols-2 gap-1.5">
                                        ...
                                        <button
                                            ...
                                            className={`text-left text-[11px] px-2 py-1.5 rounded transition-colors ${
                                                selected
                                                    ...
                                                    : "text-neutral-600 myverse-dark:text-neutral-300 hover:bg-neutral-50 myverse-dark:hover:bg-white/[0.04]"
                                            }`}
                                        >
                                            {b.label}
                                        </button>
                    ...
                    {guide.settingsUrl && (
                        <div className="border border-neutral-200 myverse-dark:border-white/8 rounded-lg p-3">
                            ...
                            <div className="flex items-center gap-2">
                                <code className="flex-1 text-xs bg-neutral-50 myverse-dark:bg-white/[0.04] px-2 py-1.5 rounded font-mono text-neutral-800 myverse-dark:text-neutral-200 truncate">
                                    {guide.settingsUrl}
                                </code>
                                <button
                                    onClick={handleCopy}
                                    className="shrink-0 p-1.5 rounded hover:bg-neutral-100 myverse-dark:hover:bg-white/[0.06] text-neutral-500 transition-colors"
                                    title="주소 복사"
                                >
                ...
                {/* 푸터 — 다시 시도 */}
                <div className="p-4 border-t border-neutral-100 myverse-dark:border-white/8 flex gap-2">
                    <button
                        onClick={onClose}
                        className="px-4 py-2 text-sm rounded-lg text-neutral-600 myverse-dark:text-neutral-300 hover:bg-neutral-50 myverse-dark:hover:bg-white/[0.06] transition-colors"
                    >
                        나중에
                    </button>
                    <button
