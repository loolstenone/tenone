...
export function DailyEntryComposer({ date, onClose, onSaved, initialImage }: Props) {
    ...
    return (
        <div className="bg-neutral-50 myverse-dark:bg-white/[0.025] rounded-lg p-4 space-y-3 border border-neutral-200 myverse-dark:border-white/8">
            {/* 미디어 영역 */}
            {media.length > 0 && (
                <div className="grid grid-cols-4 gap-1.5">
                    {media.map((m, i) => (
                        <div key={i} className="relative aspect-square bg-neutral-200 myverse-dark:bg-white/[0.06] rounded overflow-hidden group">
                            {m.kind === "image" ? (
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    className="inline-flex items-center gap-1 px-2 py-1 text-xs text-neutral-500 hover:text-[#6366F1] hover:bg-white myverse-dark:hover:bg-white/[0.04] rounded transition-colors"
                >
            ...
            <textarea
                ...
                rows={3}
                className="w-full text-sm bg-transparent text-neutral-800 myverse-dark:text-neutral-100 placeholder:text-neutral-300 placeholder:italic focus:outline-none resize-none border-b border-neutral-200 myverse-dark:border-white/8 pb-2"
            />
            ...
            <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                    ...
                    <input
                        ...
                        className="flex-1 text-xs bg-transparent focus:outline-none text-neutral-700 myverse-dark:text-neutral-200 placeholder:text-neutral-300 border-b border-neutral-200 myverse-dark:border-white/8 pb-1"
                    />
                </div>
                {bases.length > 0 && (
                    <div className="flex flex-wrap gap-1 pl-5">
                        {bases.map(b => (
                            <button
                                ...
                                className="px-2 py-0.5 text-[10px] rounded-full bg-neutral-200 myverse-dark:bg-white/[0.06] text-neutral-600 myverse-dark:text-neutral-300 hover:bg-[#6366F1]/10 hover:text-[#6366F1] transition-colors"
                            >
                                {b.name}
                            </button>
                        ))}
            ...
            <div className="flex flex-wrap items-center gap-2">
                ...
                <input
                    ...
                    step={1800}
                    className="text-xs bg-white myverse-dark:bg-[#0D0D15] border border-neutral-200 myverse-dark:border-white/8 rounded px-2 py-0.5 text-neutral-700 myverse-dark:text-neutral-200 focus:outline-none focus:border-[#6366F1]"
                />
                    ...
                    <button
                        ...
                        className={`px-2 py-0.5 text-[10px] rounded-full transition-colors ${
                            category === c.key
                                ...
                                : "bg-neutral-200 myverse-dark:bg-white/[0.06] text-neutral-500 hover:bg-neutral-300"
                        }`}
                    >
                        {c.label}
                    </button>
                        ...
                        <div className="bg-orange-50 myverse-dark:bg-orange-900/10 p-3 space-y-2">
                            ...
                            <div className="space-y-1.5">
                                {foodItems.map((food, idx) => (
                                    <div key={idx} className="flex items-center gap-2 bg-white myverse-dark:bg-white/[0.025] rounded px-2 py-1.5">
                                        ...
                                        <div className="relative shrink-0">
                                            <select
                                                ...
                                                className="appearance-none text-[10px] bg-neutral-100 myverse-dark:bg-white/[0.06] text-neutral-600 myverse-dark:text-neutral-300 rounded px-1.5 py-0.5 pr-4 focus:outline-none cursor-pointer"
                                            >
                    ...
                    {!leisureAnalyzed ? (
                        ...
                        <div className="bg-violet-50 myverse-dark:bg-violet-900/10 p-3 space-y-2.5">
                            ...
                            {leisureData.category && (
                                <div className="flex flex-wrap gap-1">
                                    <span className="px-2 py-0.5 text-[10px] rounded-full bg-white myverse-dark:bg-white/[0.025] text-neutral-500 border border-neutral-200 myverse-dark:border-white/8">
                                        {leisureData.category}
                                    </span>
                                </div>
                            )}
                            ...
                            {exerciseData.muscle_groups.length > 0 && (
                                <div className="flex flex-wrap gap-1">
                                    {exerciseData.muscle_groups.map((g, i) => (
                                        <span key={i} className="px-2 py-0.5 text-[10px] rounded-full bg-white myverse-dark:bg-white/[0.025] text-neutral-500 border border-neutral-200 myverse-dark:border-white/8">
                                            {g}
                                        </span>
                                    ))}
                                </div>
