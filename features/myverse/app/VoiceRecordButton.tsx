    ...
    return (
        <>
            ...
            {recording && typeof document !== "undefined" && (
                <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[100] w-[min(640px,calc(100vw-32px))] flex items-center gap-2 px-4 py-3 border border-rose-300 bg-white myverse-dark:bg-white/[0.03] shadow-lg rounded-xl">
