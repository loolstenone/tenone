...
export const initialPosts: CmsPost[] = [
    {
        ...
        body: '', category: 'Brand', channels: ['works', 'newsroom', 'history'], status: 'Published',
    ...
    },
    {
        ...
        body: '', category: 'Media', channels: ['newsroom', 'history'], status: 'Published',
    ...
    },
    {
        ...
        body: '', category: 'Brand', channels: ['newsroom', 'history'], status: 'Published',
    ...
    },
    {
        ...
        body: '', category: 'Event', channels: ['newsroom', 'history'], status: 'Published',
    ...
    },
    {
        ...
        body: '', category: 'Project', channels: ['newsroom', 'history'], status: 'Published',
    ...
    },
    {
        ...
        body: '', category: 'Project', channels: ['works', 'newsroom', 'history'], status: 'Published',
    ...
    },
    {
        ...
        body: '', category: 'Event', channels: ['works', 'newsroom', 'history'], status: 'Published',
    ...
    },
    {
        ...
        body: '', category: 'Brand', channels: ['history'], status: 'Published',
