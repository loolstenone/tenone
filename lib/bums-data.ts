import {
    BumsSite, BumsBoard, BumsBoardPost, BumsComment, BumsWidget, CmsPost,
...
export const initialSites: BumsSite[] = [
    {
...
export const initialBoards: BumsBoard[] = [
    // TenOne 사이트 게시판
    {
...
export const initialBoardPosts: BumsBoardPost[] = [
    // TenOne 뉴스룸
    {
...
export const initialComments: BumsComment[] = [
    {
...
export const initialWidgets: BumsWidget[] = [
    {
