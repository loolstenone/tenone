...
export const siteConfigs: Record<SiteIdentifier, SiteConfig> = {
    ...
    ogamja: {
        ...
        homePath: '/0g', signupPath: '/signup', domain: '0gamja.com',
        universeLabel: 'Powered by Ten:One™', showUniverseBadge: true,
        authMethods: { email: true, google: true, kakao: true },
        nav: [
    ...
    seoul360: {
        ...
        homePath: '/s360', signupPath: '/signup', domain: 'seoul360.net',
        universeLabel: 'Powered by Ten:One™', showUniverseBadge: true,
    ...
    mullaesian: {
        ...
        homePath: '/mls', signupPath: '/signup', domain: 'mullaesian.tenone.biz',
        universeLabel: 'Powered by Ten:One™', showUniverseBadge: true,
        authMethods: { email: false, google: false, kakao: false },
        nav: [
    ...
    fwn: {
        ...
        homePath: '/fw', signupPath: '/signup', domain: 'fwn.co.kr',
        universeLabel: 'Powered by Ten:One™', showUniverseBadge: true,
        authMethods: { email: false, google: false, kakao: false },
        nav: [
    ...
    montz: {
        ...
        homePath: '/mtz', signupPath: '/signup', domain: 'montz.tenone.biz',
        universeLabel: 'Powered by Ten:One™', showUniverseBadge: true,
        authMethods: { email: false, google: false, kakao: false },
        nav: [
            { name: 'MoNTZ', href: '/mtz' },
    ...
    trendhunter: {
        ...
        colors: { primary: '#00FF88', primaryDark: '#00CC6A', secondary: '#00FF88', headerBg: '#0A0A0A', headerText: '#ffffff', footerBg: '#0A0A0A', footerText: '#a3a3a3', accent: '#00FF88' },
        ...
        homePath: '/th', signupPath: '/signup', domain: 'trendhunter.tenone.biz',
        universeLabel: 'Powered by Ten:One™', showUniverseBadge: true,
        authMethods: { email: false, google: false, kakao: false },
        nav: [
    ...
    townity: {
        ...
        homePath: '/tw', signupPath: '/signup', domain: 'townity.tenone.biz',
        universeLabel: 'Powered by Ten:One™', showUniverseBadge: true,
        authMethods: { email: false, google: false, kakao: false },
        nav: [
    ...
    naturebox: {
        ...
        homePath: '/nb', signupPath: '/signup', domain: 'naturebox.tenone.biz',
        universeLabel: 'Powered by Ten:One™', showUniverseBadge: true,
        authMethods: { email: false, google: false, kakao: false },
        nav: [
    ...
    myverse: {
        ...
        meta: { title: 'My Universe — 나를 중심으로 한 초맞춤 AI 에이전트', description: '개인 데이터 주권 시대. 나의 능력, 관계, 기록이 만들어가는 개인화된 세계관. AI 에이전트가 나만의 우주를 운영합니다.', keywords: ['My Universe', 'MyVerse', 'AI 에이전트', '개인화', '데이터 주권', 'Ten:One'] },
        homePath: '/mv', signupPath: '/signup', domain: 'myverse.tenone.biz',
        universeLabel: 'Powered by Ten:One™', showUniverseBadge: true,
        authMethods: { email: true, google: true, kakao: true },
        nav: [
    ...
    domo: {
        ...
        homePath: '/dm', signupPath: '/signup', domain: 'domo.tenone.biz',
        universeLabel: 'Powered by Ten:One™', showUniverseBadge: true,
        authMethods: { email: true, google: true, kakao: true },
        nav: [
    ...
    jakka: {
        ...
        homePath: '/jk', signupPath: '/signup', domain: 'jakka.tenone.biz',
        universeLabel: 'Powered by Ten:One™', showUniverseBadge: true,
        authMethods: { email: false, google: false, kakao: false },
        nav: [
            { name: '포트폴리오', href: '/jk' },
